...
/**
 * Provides the local service utility for UserTable. This utility wraps
 * <code>com.safesail.service.impl.UserTableLocalServiceImpl</code> and
 ...
 * @generated
 */
public class UserTableLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.safesail.service.impl.UserTableLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static UserTable addUser(
		String quoteId, long userId, String userType) {

		return getService().addUser(quoteId, userId, userType);
	}
	 ...
	 */
	public static UserTable addUserTable(UserTable userTable) {
		return getService().addUserTable(userTable);
	}
	 ...
	 */
	public static UserTable createUserTable(String quoteId) {
		return getService().createUserTable(quoteId);
	}
	 ...
	 */
	public static UserTable deleteUserTable(String quoteId)
		throws PortalException {

		return getService().deleteUserTable(quoteId);
	}
	 ...
	 * @return the user table that was removed
	 */
	public static UserTable deleteUserTable(UserTable userTable) {
		return getService().deleteUserTable(userTable);
	}
	...
	public static UserTable fetchUserTable(String quoteId) {
		return getService().fetchUserTable(quoteId);
	}
	...
	public static UserTable getQuoteId(String quoteId) {
		return getService().getQuoteId(quoteId);
	}

	public static List<UserTable> getUser(long userId) {
	 ...
	 * @throws PortalException if a user table with the primary key could not be found
	 */
	public static UserTable getUserTable(String quoteId)
		throws PortalException {

		return getService().getUserTable(quoteId);
	}
	 ...
	 */
	public static List<UserTable> getUserTables(int start, int end) {
		return getService().getUserTables(start, end);
	}
	...
	public static int getUserTablesCount() {
		return getService().getUserTablesCount();
	}
	 ...
	 */
	public static UserTable updateUserTable(UserTable userTable) {
		return getService().updateUserTable(userTable);
	}

	public static UserTableLocalService getService() {
		return _service;
	}

	private static volatile UserTableLocalService _service;
