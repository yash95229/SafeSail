...
/**
 * Provides the local service interface for PanCardVerification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PanCardVerificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PanCardVerificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.safesail.service.impl.PanCardVerificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pan card verification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PanCardVerificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	public PanCardVerification addPan(
