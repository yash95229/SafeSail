...
/**
 * Provides the local service utility for PanCardVerification. This utility wraps
 * <code>com.safesail.service.impl.PanCardVerificationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PanCardVerificationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.safesail.service.impl.PanCardVerificationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static PanCardVerification addPan(
		long panId, String panUserName, String panNumber) {

		return getService().addPan(panId, panUserName, panNumber);
	}
	 ...
	 */
	public static PanCardVerification addPanCardVerification(
		PanCardVerification panCardVerification) {

		return getService().addPanCardVerification(panCardVerification);
	}
	 ...
	 */
	public static PanCardVerification createPanCardVerification(long panId) {
		return getService().createPanCardVerification(panId);
	}
	 ...
	 */
	public static PanCardVerification deletePanCardVerification(long panId)
		throws PortalException {

		return getService().deletePanCardVerification(panId);
	}
	 ...
	 * @return the pan card verification that was removed
	 */
	public static PanCardVerification deletePanCardVerification(
		PanCardVerification panCardVerification) {

		return getService().deletePanCardVerification(panCardVerification);
	}
	...
	public static PanCardVerification fetchPanCardVerification(long panId) {
		return getService().fetchPanCardVerification(panId);
	}
	 ...
	 * @throws PortalException if a pan card verification with the primary key could not be found
	 */
	public static PanCardVerification getPanCardVerification(long panId)
		throws PortalException {

		return getService().getPanCardVerification(panId);
	}
	 ...
	 */
	public static List<PanCardVerification> getPanCardVerifications(
		int start, int end) {

		return getService().getPanCardVerifications(start, end);
	}
	 ...
	 */
	public static int getPanCardVerificationsCount() {
		return getService().getPanCardVerificationsCount();
	}
	...
	public static String getUserByPanNumber(String PAN) {
		return getService().getUserByPanNumber(PAN);
	}
	 ...
	 */
	public static PanCardVerification updatePanCardVerification(
		PanCardVerification panCardVerification) {

		return getService().updatePanCardVerification(panCardVerification);
	}

	public static PanCardVerificationLocalService getService() {
		return _service;
	}

	private static volatile PanCardVerificationLocalService _service;
