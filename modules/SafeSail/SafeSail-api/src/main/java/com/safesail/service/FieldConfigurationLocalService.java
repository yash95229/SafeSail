...
/**
 * Provides the local service interface for FieldConfiguration. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FieldConfigurationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FieldConfigurationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.safesail.service.impl.FieldConfigurationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the field configuration local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FieldConfigurationLocalServiceUtil} if injection and service tracking are not available.
	 */
	public FieldConfiguration addFieldConfig(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FieldConfiguration> getByconfigId(long configId)
		throws NoSuchFieldConfigurationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FieldConfiguration> getByfieldData(String fieldData)
		throws NoSuchFieldConfigurationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FieldConfiguration> getByfieldName(String fieldName)
		throws NoSuchFieldConfigurationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FieldConfiguration getByfieldShow(Boolean fieldShow)
		throws NoSuchFieldConfigurationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FieldConfiguration> getByfieldSumAssured(String fieldSumAssured)
		throws NoSuchFieldConfigurationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FieldConfiguration> getByfieldValue(String fieldValue)
		throws NoSuchFieldConfigurationException;
