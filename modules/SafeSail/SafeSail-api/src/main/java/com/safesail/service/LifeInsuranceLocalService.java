...
/**
 * Provides the local service interface for LifeInsurance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LifeInsuranceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LifeInsuranceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.safesail.service.impl.LifeInsuranceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the life insurance local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LifeInsuranceLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public LifeInsurance addReg(
		String quoteId, String fullname, String email, long phoneNumber,
		String AnnualIncome, String panNumber, Date dob, String gender,
		Boolean condition, long sumAssured, long userId, String aadharNumber);

	public LifeInsurance addReg(
		String quoteId, String fullname, String email, long phoneNumber,
		String AnnualIncome, String panNumber, Date dob, String gender,
		Boolean condition, long sumAssured, long userId, String aadharNumber,
		int policyTerm, int ppterm, String paymentFrequency,
		String payoutOption, int lifeSecure, int lifeplus, int CIPBenifit,
		long totalValues, long totalAddons);
