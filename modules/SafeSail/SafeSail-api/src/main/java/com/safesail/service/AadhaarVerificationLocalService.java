...
/**
 * Provides the local service interface for AadhaarVerification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AadhaarVerificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AadhaarVerificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.safesail.service.impl.AadhaarVerificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the aadhaar verification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AadhaarVerificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	public AadhaarVerification addAadhaar(
	...
	public AadhaarVerification addAadhaarVerification(
	...
	public AadhaarVerification createAadhaarVerification(long aadhaarId);
	...
	public AadhaarVerification deleteAadhaarVerification(
		AadhaarVerification aadhaarVerification);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AadhaarVerification deleteAadhaarVerification(long aadhaarId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AadhaarVerification fetchAadhaarVerification(long aadhaarId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AadhaarVerification getAadhaarVerification(long aadhaarId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AadhaarVerification> getAadhaarVerifications(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AadhaarVerification updateAadhaarVerification(
		AadhaarVerification aadhaarVerification);
