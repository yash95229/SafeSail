	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		log.info("fieldConfigurationAgreementData_______________________"+fieldConfigurationAgreement);
			...
			if (themeDisplay.isSignedIn()) {
				...
				/*
				 * double sumAssuredVal= registerReg.getSumAssured(); String
				 * sumStirngVal=String.valueOf(sumAssuredVal);
				 * 
				 * log.info("sumAssuredVal_______________________"+sumStirngVal); sumStirngVal =
				 * sumStirngVal.toLocaleString();
				 * assertThat(currencyWithChosenLocalisation(sumAssuredVal, new Locale("en",
				 * "US")));
				 */
